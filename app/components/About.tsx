...
/* Rail facts. Kept to things that are true on the résumé — a location line
 * would fit here too, but Krush splits time between Columbus and the shops in
 * Parma, so it is deliberately left off rather than guessed. */
  ...
  return (
    <article className="pt-28 pb-16">
      <p
        ...
        className="font-mono text-[11px] uppercase tracking-[0.14em] mb-3.5"
      >
        About
      </p>
      ...
      <div className="mt-9 grid grid-cols-1 sm:grid-cols-[168px_1fr] gap-7 sm:gap-10 items-start">
        ...
        <div className="flex flex-col gap-9">
          ...
          >
            <p>
              I&rsquo;m a CS student at Ohio State and a full-stack developer at
              IGS Energy, working on the CRM their sales and service teams use
              every day.
            </p>
            <p>
